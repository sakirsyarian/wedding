...
export const metadata = {
  title: "Terms Conditions - Andaring",
};
        ...
        <div className="px-5 py-24 md:container">
          <div className={cn(defaultSpaceY)}>
            ...
            <div className={cn(defaultSpaceY, "space-y-5", "text-center")}>
              <p className={cn(defaultMiniHead)}>Terms</p>
              <div className={lora.className}>
                <h1 className={cn(defaultHead)}>Terms & Conditions</h1>
              </div>
              <p>
                Please read these terms and conditions carefully before you
                <br className="hidden lg:block" />
                start using Andaring, as they apply to your use of our website.
              </p>
            </div>
            ...
            <div className="space-y-5">
              ...
              <p>Welcome to Andaring!</p>

              <p>
                These terms and conditions outline the rules and regulations for
                the use of Andaring&apos;s Website, located at
                https://andaring.com/.
              </p>

              <p>
                By accessing this website we assume you accept these terms and
                conditions. Do not continue to use Andaring if you do not agree
              ...
              <p>
                ...
                with and subject to, prevailing law of id.
              </p>
              ...
              <p>
                We employ the use of cookies. By accessing Andaring, you agreed
                to use cookies in agreement with the Andaring&apos;s Privacy
                Policy.
              </p>
              ...
              <h3 className="font-semibold text-xl">License</h3>

              <p>
                Unless otherwise stated, Andaring and/or its licensors own the
                intellectual property rights for all material on Andaring. All
                intellectual property rights are reserved. You may access this
                from Andaring for your own personal use subjected to
                restrictions set in these terms and conditions.
              </p>

              <p>You must not:</p>
              <ul className="ml-3 space-y-3">
                <li>- Republish material from Andaring</li>
                <li>- Sell, rent or sub-license material from Andaring</li>
                <li>- Reproduce, duplicate or copy material from Andaring</li>
                <li>- Redistribute content from Andaring</li>
              </ul>

              <p>
                Parts of this website offer an opportunity for users to post and
                exchange opinions and information in certain areas of the
                website. Andaring does not filter, edit, publish or review
                Comments prior to their presence on the website. Comments do not
                reflect the views and opinions of Andaring,its agents and/or
                affiliates.
              </p>
              ...
              <p>
                ...
                laws, Andaring shall not be liable for the Comments or for any
              ...
              <p>
                Andaring reserves the right to monitor all Comments and to
              ...
              <p>
                You hereby grant Andaring a non-exclusive license to use,
              ...
              <p>
                ...
                of Andaring; and (d) the link is in the context of general
              ...
              <p>
                ...
                by sending an e-mail to Andaring. Please include your name, your
              ...
              <p>
                No use of Andaring&apos;s logo or other artwork will be allowed
